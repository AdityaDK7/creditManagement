  ...
  background-size: cover;
    ...
    <body>
        ...
        <div class="col-log-12">
            <br><br>
            <h1 class="text-center " style="color:red" >Transaction Statement</h1>
...
?>
        ...
        <div class="center" style="text-align: center" >
             <a href="index.php" style="color:chocolate; " style="text-decoration: none"><button class="btn btn-danger">Back to Home</button></a> 
        </div>
    </body>
</html>