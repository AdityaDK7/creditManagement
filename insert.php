...
<div id="id01" class="modal">-->
  ...
  <form class="modal-content animate"  method="post" action="insert.php" >
    ...
    <div class="container" style="width: 300px;">
      ...
      <br><input type="number" placeholder="Phone Number" name="Contact" required>

      <br><label for="Credits"><b>Credits</b></label>
      <br><input type="number" placeholder="Credits" name="Credits" required>
        
      <button type="submit" class="btn btn-success" name="done">Submit</button>
    </div>

    <div class="container">
       <a href="index.php"><button type="button"  class="cancelbtn btn btn-danger">Back To Home</button></a>
    </div>
